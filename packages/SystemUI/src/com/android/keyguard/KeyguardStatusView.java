...
public class KeyguardStatusView extends GridLayout implements
    ...
    private void refreshLockFont() {
        ...
        if (lockClockFont == 28) {
            ...
            mTextClock.setTypeface(Typeface.create("productsans-sys", Typeface.NORMAL));
        }
	if (lockClockFont == 29) {
	...
	if (lockClockFont == 32) {
            ...
            mTextClock.setTypeface(Typeface.create("mexcellent-sys", Typeface.NORMAL));
        }
	if (lockClockFont == 33) {
            mClockView.setTypeface(Typeface.create("burnstown-sys", Typeface.NORMAL));
            mTextClock.setTypeface(Typeface.create("burnstown-sys", Typeface.NORMAL));
        }
        if (lockClockFont == 34) {
            mClockView.setTypeface(Typeface.create("dumbledor-sys", Typeface.NORMAL));
            mTextClock.setTypeface(Typeface.create("dumbledor-sys", Typeface.NORMAL));
        }
	if (lockClockFont == 35) {
            mClockView.setTypeface(Typeface.create("phantombold-sys", Typeface.NORMAL));
            mTextClock.setTypeface(Typeface.create("phantombold-sys", Typeface.NORMAL));
        }
        if (lockClockFont == 36) {
